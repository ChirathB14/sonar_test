...
export default class CreateCustomer extends Component {
    ...
    switch (name) {
      ...
      case "password":
        if (value.length === 0) {
          ...
          formErrors.password = "Minimum 8 characaters required for password";
        } else {
          formErrors.password = "";
        }
        break;
  ...
  onSubmit =  async (e) => {
    ...
    if (formValid(this.state)) {
      ...
      console.log(data);
      try {
        await axios.post("/customer/save", data).then((res) => {
          if (res.data.success) {
            this.setState({
              name: "",
              nicNumber: "",
        ...
        <form className="needs-validation" onSubmit={this.onSubmit} noValidate>
          <div className="form-group" style={{ marginBottom: "15px" }}>
            ...
            <input
              ...
              name="name"
              placeholder="Enter your name Ex: Amal Perera"
          ...
          <div className="form-group" style={{ marginBottom: "15px" }}>
            ...
            <input
              ...
              name="nicNumber"
              placeholder="Enter your NIC number Ex: 123456789123 or 123456789v"
          ...
          <div className="form-group" style={{ marginBottom: "15px" }}>
            ...
            <input
              ...
              name="phoneNumber"
              placeholder="Enter your phone number Ex: 0712345678"
          ...
          <div className="form-group" style={{ marginBottom: "15px" }}>
            ...
            <input
              ...
              name="email"
              placeholder="Enter your email Ex: amal@gmail.com"
          ...
          <div className="form-group" style={{ marginBottom: "15px" }}>
            ...
            <input
              ...
              name="password"
              placeholder="Enter a password with minimum 8 characters including a number,lowercase letter, uppercase letter and a symbol. "
